...
class WordDifficulty:
    ...
    def evaluate_word_difficulty(self, word):
       ...
       Returns:
           PREVIOUS: str: The difficulty level of the word, which can be "easy," "moderate," or "difficult."
           NEW: int: the evaluation of the word 
       """
        word = word.lower()
        ...
        # edit made to return sum_eval instead of by strings
        return sum_eval
    ...
    def is_a_word(self, word, eval_result=None):
        ...
        """
        if (word.title() in self.names or word.lower() in self.names):
            return False
